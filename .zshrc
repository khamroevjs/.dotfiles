...
plugins=(git zsh-syntax-highlighting zsh-autocomplete zsh-autosuggestions docker)
...
# -------------------- lf ------------------------------
LFCD="/home/khamroev/.config/lf/lfcd.sh"    # pre-built binary, make sure to use absolute path
if [ -f "$LFCD" ]; then
    source "$LFCD"
    alias lf="lfcd"
fi
...
# ------ * add to history only succeeded command * ----------
